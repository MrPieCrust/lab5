...
public class EventQueue {
	...
	/**
	 * First creates a new temp ArrayList with the exTimes then sorts them and puts
	 * them back in the right order for the eventQueue
	 * 
	...
	/**
	 * returns the event next in queue.
	 * 
	 * @return - the event that is next in queue.
	 *
	 */
